...
public class UserService {
	...
	public boolean register(User user) {
        ...
        try {
        	System.out.println(" --- UserService --- register -- UsernameExist--" + uDao.isUsernameExist(user.getUsername()));
        	
        	System.out.println(" --- UserService --- register -- EmailExist--" + user);
    ...
    public User login(String ue,String password) {
        ...
        if(user!=null) {
        	System.out.println(" UserService login方法 =1111== ");
            return user;
        }
        try {
        	System.out.println(" UserService login方法 =2222== ");
        ...
        if(user!=null) {
        	System.out.println(" UserService login方法 =3333== ");
            return user;
        }
        System.out.println(" UserService login方法 =4444== ");
        return null;
    }
